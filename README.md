# Gateway Domain-Centric Routing (GDCR) - Under Construction final version.
...
> **A vendor-agnostic, metadata-driven architecture for enterprise API & Orquestraion Layers Domain-Centric Governance**
