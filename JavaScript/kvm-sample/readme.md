...
The DCRP Engine (Maverick v14.2) is designed for Metadata-Driven execution. While a dynamic mapping was possible, the current static structure was chosen to eradicate complexity and ensure O(1) lookup performance. Deviating from these naming conventions will prevent the JavaScript logic from resolving the routes correctly.
