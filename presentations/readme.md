...
The Gateway Pillar: DCRP (Domain-Centric Routing Pattern - SAP BTP Integration Suite - Especific)
...
The Backend Pillar: PDCP (Package Domain-Centric Pattern - SAP BTP Integration Suite - Especific)
