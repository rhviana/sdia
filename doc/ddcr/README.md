...
1 - PARSE      → Trata path como STRING
2 - LOOKUP     → Consulta METADATA CATALOG (DynamoDB/KVM/Redis)
3 - RESOLVE    → Match semântico → vendor concreto
4 - TRANSLATE  → Constrói target URL / invocação
5 - FORWARD    → Roteia para destino
